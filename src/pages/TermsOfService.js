...
export function TermsOfService() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Terms of Service - Al Quran AI-Powered Islamic Companion";
  }, []);
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <p className="terms-subtitle">
            Please read these Terms of Service carefully before using the <strong className="text-[var(--color-primary-dark)]">Al Quran AI-Powered Islamic Companion</strong> and related services.
          </p>
        ...
        <div className="terms-body">
          ...
          >
            <div className="card-header-flex">
              ...
              <div>
                ...
                <p className="card-subtitle">Binding agreement between you and Al Quran AI-Powered Islamic Companion</p>
              </div>
            </div>
            <p className="policy-text">
              By downloading, installing, accessing, or using the <strong>Al Quran AI-Powered Islamic Companion</strong> (`com.marsad77.alquranapp`), you acknowledge that you have read, understood, and agree to be bound by these Terms of Service and our <a href="/privacy-policy" className="text-[var(--color-primary-dark)] underline font-semibold">Privacy Policy</a>. 
            </p>
            <p className="policy-text">
          ...
          >
            ...
            <p className="policy-text">When using the Al Quran AI-Powered Islamic Companion, you agree NOT to:</p>
          ...
          >
            ...
            <p className="policy-text">
              The Al Quran AI-Powered Islamic Companion and all related content, audio, and tools are provided on an <strong>"AS IS"</strong> and <strong>"AS AVAILABLE"</strong> basis. While we strive for 100% accuracy in prayer time algorithms, Quranic text rendering, and recitation streaming, we do not guarantee uninterrupted or error-free operation.
            </p>
            <p className="policy-text">
