...
export function PrivacyPolicy() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Privacy Policy - Al Quran";
  }, []);
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <p className="privacy-subtitle">
            ...
            Learn how the <strong className="text-[var(--color-primary-dark)]">Al Quran</strong> protects your personal information, permissions, and rights.
          </p>
        ...
        <div className="privacy-body">
          ...
          >
            ...
            <p className="policy-text">
              Welcome to the <strong>Al Quran</strong> ("we," "our," or "us"). We are dedicated to providing a serene, safe, and privacy-respecting digital environment for reading the Quran, tracking daily prayers, and learning Islamic guidance. 
            </p>
            <p className="policy-text">
            ...
            <div className="deletion-steps-card mt-6">
              ...
              <ol className="steps-list">
                <li>
                  ...
                  <span>Open <strong>Al Quran</strong> and log into your account.</span>
                </li>
                <li>
